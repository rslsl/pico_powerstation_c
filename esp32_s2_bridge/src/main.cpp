...
static void setupRoutes() {
  ...
  gServer.on("/pico-ota", HTTP_GET, handlePicoOtaPage);
  ...
  gServer.on("/api/pico-ota/status", HTTP_GET, handlePicoOtaStatus);
  gServer.on("/api/pico-ota/start", HTTP_POST, handlePicoOtaStart);
  gServer.on("/api/pico-ota/chunk", HTTP_POST, handlePicoOtaChunkFinished, handlePicoOtaChunkUpload);
  gServer.on("/api/pico-ota/commit", HTTP_POST, handlePicoOtaCommit);
  gServer.on("/api/pico-ota/abort", HTTP_POST, handlePicoOtaAbort);
